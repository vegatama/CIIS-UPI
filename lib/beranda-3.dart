...
class BerandaList {
  String gelar;
  double jumlah;
  BerandaList({required this.gelar, required this.jumlah});
}
...
class Beranda {
  ...
  Beranda(List<dynamic> json) {
    ...
    for (var i = 0; i < 3; i++) {
      ...
      ListPop.add(BerandaList(gelar: gelar, jumlah: jumlah));
    }
  }
...
//class state
class MyAppState extends State<Beranda3> {
  late Future<Beranda> futureBeranda;

  String url =
      "https://opensheet.elk.sh/1nTVgY_A1qE5wwZi76jh_5oSMWP5d11XSTjZfNhDa-3A/beranda-3";
