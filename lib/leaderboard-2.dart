...
//class state
class MyAppState extends State<leaderboard2> {
  late Future<Leaderboard> futureLeaderboard;

  String url =
      "https://opensheet.elk.sh/1nTVgY_A1qE5wwZi76jh_5oSMWP5d11XSTjZfNhDa-3A/leaderboard-2";
            ...
            child: SizedBox(
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    trailing: Text(snapshot.data!.ListPop[index].pts.toString(),
