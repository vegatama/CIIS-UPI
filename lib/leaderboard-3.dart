...
//class state
class MyAppState extends State<leaderboard3> {
  late Future<Leaderboard> futureLeaderboard;

  String url =
      "https://opensheet.elk.sh/1nTVgY_A1qE5wwZi76jh_5oSMWP5d11XSTjZfNhDa-3A/leaderboard-3";
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    snapshot.data!.ListPop[index].nip
                                        .toString(),
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 12),
                                  ),
