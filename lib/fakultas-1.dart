...
class Fakultas1 extends StatefulWidget {
  @override
...
//class state
class MyAppState extends State<Fakultas1> {
  late Future<Fakultas> futureFakultas;

  String url =
      "https://opensheet.elk.sh/1nTVgY_A1qE5wwZi76jh_5oSMWP5d11XSTjZfNhDa-3A/fakultas-1";
